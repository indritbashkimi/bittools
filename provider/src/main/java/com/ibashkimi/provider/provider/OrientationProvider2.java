...
public class OrientationProvider2 extends AndroidProvider {

    private final WindowManager mWindowManager;

    private int mLastAccuracy;

    public OrientationProvider2(@NotNull Context context, int samplingPeriodUs) {
        this(context, Sensor.TYPE_ROTATION_VECTOR, samplingPeriodUs);
    }

    OrientationProvider2(@NotNull Context context, int sensor, int samplingPeriodUs) {
