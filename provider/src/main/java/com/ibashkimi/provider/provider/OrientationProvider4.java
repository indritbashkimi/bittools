 ...
 */
public class OrientationProvider4 extends AndroidProvider {
    ...
    public OrientationProvider4(@NotNull Context context, int samplingPeriodUs) {
    ...
    public void onSensorChanged(@NonNull SensorEvent event) {
        ...
        onDataChanged(new OrientationData(balance, pitch, -roll));
    }
